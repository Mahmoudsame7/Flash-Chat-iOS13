...
class ChatViewController: UIViewController {
    ...
    var Messages:[Message]=[
        ...
        //Message(sender: "1@2.com", body: "what's up? hnfhndhsbhf dhsbdhbdhnf hsnsnhd fh hdsnhhdhhf hdhnfhd")
    ]
    ...
    func loadMessages(){
        ...
        db.collection(K.FStore.collectionName)
            ...
            if let e = error{
                print("there was an error while retrieving data from firestore, \(e)")
            }
            else{
                ...
                if let documents = querySnapshot?.documents{
                    for document in documents{
                        ...
                        let senderMessage=data[K.FStore.senderField] as? String
                        let bodyMessage=data[K.FStore.bodyField] as? String
                        if let sender = senderMessage , let body=bodyMessage{
